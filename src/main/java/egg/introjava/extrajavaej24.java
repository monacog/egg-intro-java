...
public class extrajavaej24 {


    public static void main(String[] args) {
        int n;
        Scanner leer =new Scanner(System.in);
        System.out.print("Ingrese el valor de `n` y calcule la serie hasta llegar a ese valor: ");
        n=leer.nextInt();
        while(n<1){
            System.out.println("Ingrese un numero mayor a cero: ");
            n=leer.nextInt();
        }
        System.out.println("La serie "+ n + " de fibonacci es: " + fibonacci(n));
